...
<div class="clearfix"></div>
        ...
        <form method="POST" action="createdosen" enctype="multipart/form-data" >
                {{csrf_field()}}
                  <div class="form-group">
                    <label for="nidn">NIDN</label>
                    <input name="nidn" class="form-control" id="nidn" type="text" placeholder="Nomor Induk Dosen Nasional">                 
                    @error('nidn')
...
@enderror
                  ...
                  <div class="form-group">
                    ...
                    <input name="pendidikan_terakhir" class="form-control" id="pendidikan_terakhir" type="text" placeholder="Pendidikan Terakhir">
